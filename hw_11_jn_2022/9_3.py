...
def f1(s, h, n):
    if s >= 140:
        ...
        if n >= 2: return False
            ...
            if h == 1: return f1(s + 2, 2, n + 1) and f1(s * 3, 3, n + 1)
            elif h == 2: return f1(s + 1, 1, n + 1) and f1(s * 3, 3, n + 1)
            elif h == 3: return f1(s + 1, 1, n + 1) and f1(s + 2, 2, n + 1)
            else: return f1(s + 1, 1, n + 1) and f1(s + 2, 2, n + 1) and f1(s * 3, 3, n + 1)
        else:
            ...
            else: return f1(s + 1, 1, n + 1) or f1(s + 2, 2, n + 1) or f1(s * 3, 3, n + 1)

for s in range(1, 140):
    if f(s, 0, 0) and not(f1(s, 0, 0)):
        print(s)
#15